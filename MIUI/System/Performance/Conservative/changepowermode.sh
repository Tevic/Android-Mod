    ...
    "MI 3W" | "MI 3C")
        case "$powermode" in
            "high")
                 ...
                 echo 20000                                > /sys/devices/system/cpu/cpufreq/conservative/above_hispeed_delay
                 echo 60                                   > /sys/devices/system/cpu/cpufreq/conservative/go_hispeed_load
                 echo 1190400                              > /sys/devices/system/cpu/cpufreq/conservative/hispeed_freq
                 echo 70                                   > /sys/devices/system/cpu/cpufreq/conservative/target_loads
                 echo 40000                                > /sys/devices/system/cpu/cpufreq/conservative/min_sample_time
            ...
            "middle")
                 ...
                 echo 2265600                              > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
                 echo 2265600                              > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
                 echo "20000 1400000:40000 1700000:20000"  > /sys/devices/system/cpu/cpufreq/conservative/above_hispeed_delay
                 echo 90                                   > /sys/devices/system/cpu/cpufreq/conservative/go_hispeed_load
                 echo 1190400                              > /sys/devices/system/cpu/cpufreq/conservative/hispeed_freq
                 echo "85 1500000:90 1800000:70"           > /sys/devices/system/cpu/cpufreq/conservative/target_loads
                 echo 40000                                > /sys/devices/system/cpu/cpufreq/conservative/min_sample_time
                 echo 20                                   > /sys/module/cpu_boost/parameters/boost_ms
                 echo 1728000                              > /sys/module/cpu_boost/parameters/sync_threshold
             ...
             "low")
                 ...
                 echo "40000"                              > /sys/devices/system/cpu/cpufreq/conservative/above_hispeed_delay
                 echo 90                                   > /sys/devices/system/cpu/cpufreq/conservative/go_hispeed_load
                 echo 960000                               > /sys/devices/system/cpu/cpufreq/conservative/hispeed_freq
                 echo "85 960000:70"                       > /sys/devices/system/cpu/cpufreq/conservative/target_loads
                 echo 40000                                > /sys/devices/system/cpu/cpufreq/conservative/min_sample_time
    ...
    "LEO "* | "MI 4"* | "MI NOTE"* | "VIRGO"*)
        case "$powermode" in
            ...
            "middle")
                 ...
                 echo 2457600                              > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
                 echo 40000                            	   > /sys/devices/system/cpu/cpufreq/conservative/above_hispeed_delay
                 echo 70                                   > /sys/devices/system/cpu/cpufreq/conservative/go_hispeed_load
                 echo 2457600                              > /sys/devices/system/cpu/cpufreq/conservative/hispeed_freq
                 echo 70                                   > /sys/devices/system/cpu/cpufreq/conservative/target_loads
                 echo 40000                                > /sys/devices/system/cpu/cpufreq/conservative/min_sample_time
                 echo 20                                   > /sys/module/cpu_boost/parameters/boost_ms
